...
// const BASE_URL = 'http://192.168.44.236/iclass/api/';
const BASE_URL = 'https://iclass.school/api/';

//CLASS
const GET_CLASS_URL           = BASE_URL+'class/class.php?';
const GET_SUBJECT_URL         = BASE_URL+'class/subject.php?';
const GET_TOPIC_URL           = BASE_URL+'class/topic.php?';
const GET_VIDEO_PDF_URL       = BASE_URL+'class/video_and_pdf.php?';
